...
See the release notes for the [Apache Mina SSHD {{< version_sshd >}} release](./sshd-project/download_{{< version_sshd >}}.html).

* Source distributions:
    * [Apache Mina SSHD {{< version_sshd >}} Sources (.tar.gz)](https://dlcdn.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}-src.tar.gz) [PGP](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}-src.tar.gz.asc) [SHA512](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}-src.tar.gz.sha512)
    * [Apache Mina SSHD {{< version_sshd >}} Sources (.zip)](https://dlcdn.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}-src.zip) [PGP](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}-src.zip.asc) [SHA512](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}-src.zip.sha512)
* Binary distributions:
    * [Apache Mina SSHD {{< version_sshd >}} Binary (.tar.gz)](https://dlcdn.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}.tar.gz) [PGP](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}.tar.gz.asc) [SHA512](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}.tar.gz.sha512)
    * [Apache Mina SSHD {{< version_sshd >}} Binary (.zip)](https://dlcdn.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}.zip) [PGP](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}.zip.asc) [SHA512](https://downloads.apache.org/mina/sshd/{{< version_sshd >}}/apache-sshd-{{< version_sshd >}}.zip.sha512)
